...
// Pre-calculated CRC16-CCITT table for polynomial 0x1021
...
uint16_t calculate_sd_crc16_fast(const uint8_t *data, size_t length) {
	uint16_t cksum = 0x0000;
	for (int i = 0;  i < length;  i++)
		cksum = crc16_table[((cksum>>8) ^ *data++) & 0xff] ^ (cksum << 8);
